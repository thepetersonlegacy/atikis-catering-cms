...
const HowItWorksSection = () => {
  ...
  return (
    <section className="w-full overflow-x-hidden py-8 md:py-12 lg:py-16 bg-gradient-to-r from-gray-900 to-black" aria-label="How our aviation catering process works">
